        ...
        implements ORecordVersion
{
    ...
    private static final class OSimpleVersionSerializer
            implements ORecordVersionSerializer
    {
        ...
        @Override
        public int writeTo(byte[] iStream,
                           int pos,
                           ORecordVersion version)
        {
            final OSimpleVersion simpleVersion = (OSimpleVersion) version;
        ...
        @Override
        public int readFrom(byte[] iStream,
                            int pos,
                            ORecordVersion version)
        {
            final OSimpleVersion simpleVersion = (OSimpleVersion) version;
        ...
        @Override
        public long readFrom(OFile file,
                             long offset,
                             ORecordVersion version)
                throws IOException
        {
        ...
        @Override
        public int fastWriteTo(byte[] iStream,
                               int pos,
                               ORecordVersion version)
        {
            final OSimpleVersion simpleVersion = (OSimpleVersion) version;
        ...
        @Override
        public int fastReadFrom(byte[] iStream,
                                int pos,
                                ORecordVersion version)
        {
            final OSimpleVersion simpleVersion = (OSimpleVersion) version;
