 ...
 * @see OSimpleVersion
 */
public interface ORecordVersion
        extends Comparable<ORecordVersion>, Externalizable
{
    ...
    public interface ORecordVersionSerializer
    {
         ...
         *
         * @param iStream stream to write data.
         * @param pos     the beginning index, inclusive.
         * @param version
         * @return size of serialized object
         */
        int writeTo(byte[] iStream,
                    int pos,
                    ORecordVersion version);
         ...
         *
         * @param iStream stream that contains serialized data.
         * @param pos     the beginning index, inclusive.
         * @param version
         * @return size of deserialized object
         */
        int readFrom(byte[] iStream,
                     int pos,
                     ORecordVersion version);

        int writeTo(OFile file,
                    long offset,
                    ORecordVersion version)
                throws IOException;

        long readFrom(OFile file,
                      long offset,
                      ORecordVersion version)
                throws IOException;
