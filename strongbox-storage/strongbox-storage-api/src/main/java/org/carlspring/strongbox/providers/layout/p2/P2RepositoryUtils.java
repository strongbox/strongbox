...
class P2RepositoryUtils {
    ...
    static P2ArtifactCoordinates createArtifact(Attributes atts) {
        return new P2ArtifactCoordinates(atts.getValue(P2ArtifactCoordinates.ID), atts.getValue(P2ArtifactCoordinates.VERSION), atts.getValue(P2ArtifactCoordinates.CLASSIFIER));
    }
}
