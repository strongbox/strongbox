        ...
        implements LayoutProvider<T>
{
    ...
    protected abstract T getArtifactCoordinates(RepositoryPath repositoryPath)
            throws IOException;
            ...
            throws IOException
    {
        ...
        RepositoryArtifactIdGroupEntry artifactIdGroup = repositoryArtifactIdGroupService.findOne(storage.getId(),
                                                                                                  repository.getId(),
                                                                                                  c.getId());
