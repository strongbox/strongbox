...
public class RepositoryArtifactIdGroupServiceImpl
        extends AbstractArtifactGroupService<RepositoryArtifactIdGroupEntity>
        implements RepositoryArtifactIdGroupService
{

    private static final Logger logger = LoggerFactory.getLogger(RepositoryArtifactIdGroupEntity.class);

    @Inject
    private ArtifactTagService artifactTagService;

    @Override
    public void addArtifactToGroup(RepositoryArtifactIdGroupEntity artifactGroup,
    ...
    @Override
    public List<RepositoryArtifactIdGroupEntity> findMatching(String storageId,
                                                             String repositoryId,
    ...
    public RepositoryArtifactIdGroupEntity findOneOrCreate(String storageId,
                                                          String repositoryId,
                                                          String artifactId)
    {
        Optional<RepositoryArtifactIdGroupEntity> optional = tryFind(storageId, repositoryId, artifactId);
        if (optional.isPresent())
        {
            return optional.get();
        }

        RepositoryArtifactIdGroupEntity artifactGroup = create(storageId, repositoryId, artifactId);
    ...
    protected Optional<RepositoryArtifactIdGroupEntity> tryFind(String storageId,
                                                               String repositoryId,
                                                               String artifactId)
    {
    ...
    protected RepositoryArtifactIdGroupEntity create(String storageId,
                                                    String repositoryId,
                                                    String artifactId)
    {
        return new RepositoryArtifactIdGroupEntity(storageId, repositoryId, artifactId);
    }

    public RepositoryArtifactIdGroupEntity findOne(String storageId,
                                                  String repositoryId,
                                                  String artifactId)
    {
        Map<String, String> params = new HashMap<>();
        ...
        List<RepositoryArtifactIdGroupEntity> resultList = getDelegate().command(oQuery)
                                                                       .execute(params);
