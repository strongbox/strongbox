        ...
        extends TestCaseWithArtifactGenerationWithIndexing
{
            ...
            throws Exception
    {
        ...
        createTestRepository(STORAGE0, "repository-management-releases-test-create-repository");

        createTestRepository(STORAGE0, "repository-management-releases-test-create-and-delete");
