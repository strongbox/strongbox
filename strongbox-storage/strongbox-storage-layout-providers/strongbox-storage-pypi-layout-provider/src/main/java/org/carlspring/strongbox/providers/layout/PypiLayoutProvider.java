...
import org.carlspring.strongbox.repository.PypiWheelRepositoryManagementStrategy;
        ...
        extends AbstractLayoutProvider<PypiWheelArtifactCoordinates>
{
    ...
    @Inject
    private PypiWheelRepositoryManagementStrategy pypiRepositoryManagementStrategy;
