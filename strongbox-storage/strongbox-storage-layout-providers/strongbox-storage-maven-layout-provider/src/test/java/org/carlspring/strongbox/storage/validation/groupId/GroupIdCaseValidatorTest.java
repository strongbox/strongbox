...
public class GroupIdCaseValidatorTest {

    @Spy GroupIdCaseValidator groupIdCaseValidator = new GroupIdCaseValidator();
    ...
    @Test(expected = GroupIdValidationException.class)
    public void validateGroupIdCase() throws Exception {
       ...
       when(repositoryFileAttributes.getCoordinates()).thenReturn(mavenArtifactCoordinates);
        groupIdCaseValidator.validateGroupIdCase(repositoryPath);
    }
