...
public class MavenRepositoryConfiguration
        extends CustomRepositoryConfiguration implements MavenRepositoryConfigurationData
{
    ...
    public MavenRepositoryConfiguration(final MavenRepositoryConfigurationDto delegate)
    {
