...
import org.carlspring.strongbox.nuget.metadata.ContentFile;
...
import org.carlspring.strongbox.nuget.metadata.File;
import org.carlspring.strongbox.nuget.metadata.FrameworkAssembly;
import org.carlspring.strongbox.nuget.metadata.PackageType;
import org.carlspring.strongbox.nuget.metadata.Repository;
import org.carlspring.strongbox.nuget.metadata.StringListTypeAdapter;
import org.carlspring.strongbox.nuget.metadata.VersionTypeAdapter;
...
public class Nuspec implements Serializable {
     ...
     * @throws NugetFormatException XML does not conform to the NuGet specification
     */
    ...
    /**
     * @param frameworkAssembly depending on the assemblies that come with the .NET package
     */
     ...
     *
     * @param outputStream stream for recording
     * @throws JAXBException XML Conjugation Error
     */
