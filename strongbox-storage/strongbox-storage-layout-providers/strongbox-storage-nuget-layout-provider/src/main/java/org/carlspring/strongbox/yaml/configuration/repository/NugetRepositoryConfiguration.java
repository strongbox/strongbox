...
public class NugetRepositoryConfiguration
        extends CustomRepositoryConfiguration implements NugetRepositoryConfigurationData
{
    ...
    public NugetRepositoryConfiguration(final NugetRepositoryConfigurationDto delegate)
    {
