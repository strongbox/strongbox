 ...
 * @author Kate Novik.
 */
public class GenerateMavenChecksumOperation
        extends AbstractArtifactLocationHandler
{

    private static final Logger logger = LoggerFactory.getLogger(
            GenerateMavenChecksumOperation.class);
    ...
    public GenerateMavenChecksumOperation(MavenChecksumManager mavenChecksumManager)
    {
