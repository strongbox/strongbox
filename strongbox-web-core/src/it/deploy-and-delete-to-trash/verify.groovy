...
def artifact = ArtifactUtils.getArtifactFromGAV("org.carlspring.maven:test-project:1.1");
...
def artifactFile = new File("target/storages/storage0/releases-with-trash/" +
                            "org/carlspring/maven/test-project/1.1/test-project-1.1.jar").getAbsoluteFile();
