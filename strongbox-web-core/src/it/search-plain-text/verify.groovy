...
def r3 = client.searchLucene("releases", "g:org.carlspring.* v:1.0.5");
def r4 = client.searchLucene("releases", "u:org.carlspring.*|1.0*");
...
return r0.indexOf("1.0.11") >= 0 && r1.indexOf("1.0.11") >= 0 &&
       ...
       r4.indexOf("1.0.10") >= 0 && r5.contains("1.0.10");
