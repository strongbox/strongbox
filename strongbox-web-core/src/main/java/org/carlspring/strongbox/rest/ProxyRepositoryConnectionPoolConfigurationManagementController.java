...
public class ProxyRepositoryConnectionPoolConfigurationManagementController
        extends BaseRestlet
{
    ...
    @RequestMapping(value = "{storageId}/{repositoryId}/{numberOfConnections}", method = RequestMethod.PUT,
    ...
    @ApiResponses(value = {
                                  ...
                                  @ApiResponse(code = 500, message = "An error occurred.") })
    @RequestMapping(value = "default/{numberOfConnections}", method = RequestMethod.PUT,
                    produces = MediaType.TEXT_PLAIN_VALUE)
    ...
    @ApiResponses(value = {
                                  ...
                                  @ApiResponse(code = 500, message = "An error occurred.") })
    @RequestMapping(value = "default-number", method = RequestMethod.GET, produces = MediaType.TEXT_PLAIN_VALUE)
    public ResponseEntity getDefaultNumberOfConnectionsForProxyRepository()
    {
        ...
        return ResponseEntity.ok(defaultNumber);
    }
    ...
    @ApiResponses(value = {
                                  ...
                                  @ApiResponse(code = 500, message = "An error occurred.") })
    @RequestMapping(value = "max/{numberOfConnections}", method = RequestMethod.PUT,
                    produces = MediaType.TEXT_PLAIN_VALUE)
    ...
    public ResponseEntity getMaxNumberOfConnectionsForProxyRepository()
    {
        ...
        return ResponseEntity.ok(maxNumberOfConnections);
    }
}
