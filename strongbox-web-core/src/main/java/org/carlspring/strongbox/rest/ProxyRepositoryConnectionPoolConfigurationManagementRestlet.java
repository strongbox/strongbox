...
public class ProxyRepositoryConnectionPoolConfigurationManagementRestlet
        extends BaseRestlet
{
    ...
    public Response setNumberOfConnectionsForProxyRepository(@PathParam(value = "storageId") String storageId,
                                                             ...
                                                             @PathParam(value = "numberOfConnections")
                                                                            ...
                                                                            int numberOfConnections)
    {
        ...
        return Response.ok().entity(
                "Default number of connections for proxy repository was updated successfully.").build();
    }
