...
public class ProxyRepositoryConnectionPoolConfigurationManagementControllerTest
    ...
    public void testSetNumberOfConnectionsForProxyRepository() {
        ...
        Assert.assertEquals("Number of pool connections for repository was updated successfully.", response.response().getBody().asString());
    }
    ...
    public void testGetNumberOfConnectionsForProxyRepository() {
        ...
        String url = getContextBaseUrl() + "/configuration/proxy/connection-pool/" + repository.getStorage().getId() + "/" + repository.getId();
